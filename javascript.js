...
document.addEventListener('DOMContentLoaded', function () {
    ...
    for (let i = 1; i <= 15; i++) {
        sectionData.phySec1.push({
            ...
            : generateUrl('WPE%20%2B%20CIRCULAR%20MAINS%20TEST', i),  // Default URL for other questions
            options
             : i === 9 ? ["2ak/π", "ak/π", "3ak/π", "2ak/3π"]
            : i === 5 ? ["L/2", "L/4", "L/8", "L/3"]
            : i === 8 ? ["(6/5)^1/2", "1", "0.5", "NONE"]
    ...
    for (let i = 1; i <= 15; i++) {
        sectionData.chemSec1.push({
            ...
            ? "https://firebasestorage.googleapis.com/v0/b/mentorsmantratestportal1.appspot.com/o/GOC%20MAINS%20QUES%2F27%20(1).jpeg?alt=media&token=3c04a667-ac18-4747-851e-a86bdb28c3fc"
              //: i === 9 
            //? "https://firebasestorage.googleapis.com/v0/b/mentorsmantratestportal1.appspot.com/o/WPE%20%2B%20CIRCULAR%20MAINS%20TEST%2FCOM%20ADV%20QUES%2F5.jpeg?alt=media&token=90d1cb20-cd1c-453a-9a6e-8b44c56a9201"
           : generateUrl('PERIODIC%20MAINS%2016%20QUES', i),
            options
            : i === 7 ? ["2", "8", "4", "6"]
            : i === 12 ? ["2", "4", "6", "8"]
           : i === 13 ? ["3", "9", "1", "2"]
    ...
    for (let i = 1; i <= 20; i++) {
        sectionData.mathsSec1.push({
            questionNumber: i,
            url: generateUrl('LCD%20MAINS%20TEST', i),
            options: ["A", "B", "C", "D"],
            correctAnswer: [
                /*1*/ "D",
/*2*/ "B",
...
/*15*/ "B"
    ...
    for (let i = 1; i <= 15; i++) {
        sectionData.bioSec1.push({
            questionNumber: i,
            url: generateUrl('CELL%20BICYCLE%20%2B%20BIOMOLECULE%20MAINS%20TEST', i),
            options: ["A", "B", "C", "D"],
            correctAnswer: [
                /*1*/ "D",
                /*2*/ "C",
                ...
                /*13*/ "A",
                /*14*/ "A",
                /*15*/ "A"][i - 1]  // Adjust correct answers as needed
        });
    }
